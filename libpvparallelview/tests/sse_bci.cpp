...
/*void sse_bci(unsigned int* bcodes, unsigned int* indexes, PVCore::PVHSVColor*
colors, PVParallelView::PVBCICode<NBITS_INDEX>* bci_codes)
{
        __m128i sse_lr;
...
#define SHUFFLE _MM_SHUFFLE(0, 3, 2, 1)
	...
	PVParallelView::PVBCICode<NBITS_INDEX>* bci_codes_serial =
	    PVParallelView::PVBCICode<NBITS_INDEX>::allocate_codes(NBUCKET);
	PVParallelView::PVBCICode<NBITS_INDEX>* bci_codes_sse =
	    PVParallelView::PVBCICode<NBITS_INDEX>::allocate_codes(NBUCKET);
