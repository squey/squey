...
void PVParallelView::PVFullParallelViewSelectionRectangle::update_position()
{
	...
	double new_left = get_lines_view().get_left_border_position_of_zone_in_scene(zone_id1) +
	                  (double)get_lines_view().get_zone_width(zone_id1) * factor1;
	double new_right = get_lines_view().get_left_border_position_of_zone_in_scene(zone_id2) +
	                   (double)get_lines_view().get_zone_width(zone_id2) * factor2;
