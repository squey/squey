...
public:
	...
	void process_sel(ProcessParams const& params, PVScatterViewImage& image, Inendi::PVSelection const& sel, tbb::task_group_context* ctxt = nullptr) const override;

private:
	static void process_image(ProcessParams const& params, PVScatterViewImage& image, Inendi::PVSelection const* sel = nullptr, tbb::task_group_context* ctxt = nullptr);
};
