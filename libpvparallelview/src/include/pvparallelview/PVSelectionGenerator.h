...
namespace PVSelectionGenerator
{
	...
	uint32_t compute_selection_from_parallel_view_rect(
	...
	uint32_t compute_selection_from_hit_count_view_rect(
	...
	uint32_t compute_selection_from_plotted_range(
	...
	uint32_t compute_selection_from_plotteds_ranges(
