...
/******************************************************************************
 *
 * PVParallelView::PVLinesView::get_zone_absolute_position_in_scene
 *
 *****************************************************************************/
uint32_t PVParallelView::PVLinesView::get_zone_absolute_position_in_scene(PVZoneID zone_id) const
{
	assert(zone_id < (PVZoneID) _zones_width.size());
