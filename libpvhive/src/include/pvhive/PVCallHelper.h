...
class PVCallHelper
{
  public:
	...
	static typename PVCore::PVTypeTraits::function_traits<F>::result_type
	call(PVCore::PVSharedPtr<T>& object, P&&... params)
	{
		PVActor<T> actor;
...
template <typename F, F f> struct PVHiveFuncCaller
{
	...
	static typename PVCore::PVTypeTraits::function_traits<func_t>::result_type
	call(PVCore::PVSharedPtr<T>& object, P&&... params)
	{
