...
class PVObserverObjectBase
{
  ...
  public:
	PVObserverObjectBase()
	    : _object(nullptr), _registered_object(nullptr), _accept_recursive_refreshes(false)
	{
  ...
  protected:
	...
	// Deadlock mlay occur if an observer of an object is deleted during an about_to_be_deleted
