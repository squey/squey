...
#define PVHIVE_CALL_OBJECT_BLOCK_BEGIN()                                                           \
	namespace PVHive                                                                               \
	{
...
#define IMPL_WAX(Method, obj, args)                                                                \
	template <>                                                                                    \
	typename PVCore::PVTypeTraits::function_traits<decltype(&Method)>::result_type                 \
	PVHive::call_object<decltype(&Method), &Method>(                                               \
	    typename PVCore::PVTypeTraits::function_traits<decltype(&Method)>::class_type * obj,       \
	    typename PVCore::PVTypeTraits::function_traits<decltype(&Method)>::arguments_type const&   \
	        args)

/*
#define IMPL_WAX_OVERLOAD(RetType, Class, Method, obj, args, Params...) \
    template <> \
    RetType PVHive::call_object<RetType(Class::*)(Params), &Class::Method>(Class* obj, typename
PVCore::PVTypeTraits::function_traits<RetType(Class::*)(Params)>::arguments_type const& args)
*/
