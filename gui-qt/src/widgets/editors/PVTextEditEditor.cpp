...
void PVInspector::PVTextEditEditor::slot_import_file()
{
...
PVCore::PVPlainTextType PVInspector::PVTextEditEditor::get_text() const
{
...
void PVInspector::PVTextEditEditor::set_text(PVCore::PVPlainTextType const& text)
{
