...
/******************************************************************************
 *
 * PVInspector::PVImportFileDialog::PVImportFileDialog
 *
 *****************************************************************************/
PVInspector::PVImportFileDialog::PVImportFileDialog(QWidget *parent) : QFileDialog(parent)
{
	...
	PVMainWindow *main_win = dynamic_cast<PVInspector::PVMainWindow*>(parent);
	...
	QStringList pluginslist = main_win->root->normalize.plugins_list_all();
...
/******************************************************************************
 *
 * PVInspector::PVImportFileDialog::getFileName()
 *
 *****************************************************************************/
QStringList PVInspector::PVImportFileDialog::getFileNames(QString& treat_as)
{
...
/******************************************************************************
 *
 * PVInspector::PVImportFileDialog::setDefaults()
 *
 *****************************************************************************/
void PVInspector::PVImportFileDialog::setDefaults()
{
