...
public:
	...
	void operator()(PVBCIBackendImage<Bbits>& dst_img, size_t x_start, size_t width, PVBCICode<Bbits>* codes, size_t n) const
	{
...
#pragma omp critical
		{
			...
			__impl::cuda_kernel<Bbits>::launch(_device_codes, n, width, dst_img_cuda->device_img(), dst_img_cuda->width(), x_start, _main_stream);
