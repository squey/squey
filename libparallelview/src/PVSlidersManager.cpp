...
void PVParallelView::PVSlidersManager::del_zoom_sliders(const axis_id_t &axis_id,
                                                        const id_t id)
{
...
void PVParallelView::PVSlidersManager::iterate_zoomed_selection_sliders(const range_functor_t &functor) const
{
