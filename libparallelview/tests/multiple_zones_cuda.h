...
PVParallelView::PVBCICode* init_cuda_codes(int device = 0);
...
void copy_codes_to_cuda(PVParallelView::PVBCICode* host_codes, PVParallelView::PVBCICode* device_codes, size_t n, cudaStream_t stream = NULL);
