...
namespace PVGL {
	...
	/**
	 * Window able to manager the different window types
	 * that can be provided by the toolkits.
	 */
	class WtkWindow {
	protected:
	...
	public:
		...
		int get_max_lines_per_redraw()const{return max_lines_per_redraw;}
	 ...
	 * @return
	 */
	/* int (PVGL::WTK::WtkWindow::*current_scheduler)(PVGL::PVIdleTaskKinds kind); */
