...
#	AG: if CMAKE_JAR_MAIN_CLASS is set, a manifest file is created within
#	the JAR archive that set the Main-Class attribute to ${CMAKE_JAR_MAIN_CLASS}.
#
...
function(add_jar _TARGET_NAME)
	...
	if (CMAKE_JAR_MAIN_CLASS)
		set(_JAVA_MANIFEST ${CMAKE_JAVA_CLASS_OUTPUT_PATH}/Manifest.txt)
		file(WRITE ${_JAVA_MANIFEST} "Main-Class: " ${CMAKE_JAR_MAIN_CLASS} "\n")
		set(_JAVA_JAR_OPTIONS "-cfm")
		unset(CMAKE_JAR_MAIN_CLASS)
	else(CMAKE_JAR_MAIN_CLASS)
		set(_JAVA_MANFIEST "")
		set(_JAVA_JAR_OPTIONS "-cf")
	endif(CMAKE_JAR_MAIN_CLASS)

    if (CMAKE_JNI_TARGET)
        add_custom_command(
            TARGET ${_TARGET_NAME}
            COMMAND ${CMAKE_Java_ARCHIVE}
			${_JAVA_JAR_OPTIONS} ${CMAKE_CURRENT_BINARY_DIR}/${_JAVA_TARGET_OUTPUT_NAME} ${_JAVA_MANIFEST}
