...
# TULIP_QT5_LIBRARY: Absolute path of libtulip-qt
...
IF(TULIP_DIR)
  ...
  IF(NOT TULIP_OGL_LIBRARY)
    FIND_LIBRARY(TULIP_OGL_LIBRARY "tulip-ogl-${TULIP_VERSION}"
                 ...
                 NO_DEFAULT_PATH)
  ENDIF()
  IF(NOT TULIP_QT5_LIBRARY)
    FIND_LIBRARY(TULIP_QT5_LIBRARY "tulip-qt5-${TULIP_VERSION}"
                 PATHS ${LIBDIR}
                 NO_DEFAULT_PATH)
  ENDIF()
  ...
  SET(TULIP_LIBS ${TULIP_LIBRARY} ${TULIP_OGL_LIBRARY} ${TULIP_QT5_LIBRARY})
...
IF(TULIP_INCLUDE_DIR AND TULIP_DIR AND TULIP_LIBRARY AND TULIP_PLUGIN_VERSION AND TULIP_VERSION AND TULIP_PLUGINS_PATH AND TULIP_SHARE_DIR)
  ...
  IF(TULIP_OGL_LIBRARY)
    ...
    IF(TULIP_QT5_LIBRARY)
      MARK_AS_ADVANCED(TULIP_QT5_LIBRARY)
...
MACRO (TULIP_QT5_WRAP_UI outfiles )
  ...
  ENDFOREACH (it)
ENDMACRO (TULIP_QT5_WRAP_UI)

MACRO (TULIP_QT5_WRAP_UI_IN_INCLUDE outfiles )
  QT5_EXTRACT_OPTIONS(ui_files ui_options ${ARGN})
  FOREACH (it ${ui_files})
    GET_FILENAME_COMPONENT(outfile ${it} NAME_WE)
    GET_FILENAME_COMPONENT(infile ${it} ABSOLUTE)
    ...
    SET(${outfiles} ${${outfiles}} ${outfile})
  ENDFOREACH (it)
ENDMACRO (TULIP_QT5_WRAP_UI_IN_INCLUDE)

MACRO (TULIP_QT5_WRAP_UI_IN_INCLUDE_TULIP outfiles )
  QT5_EXTRACT_OPTIONS(ui_files ui_options ${ARGN})
  FOREACH (it ${ui_files})
    GET_FILENAME_COMPONENT(outfile ${it} NAME_WE)
    GET_FILENAME_COMPONENT(infile ${it} ABSOLUTE)
    ...
    SET(${outfiles} ${${outfiles}} ${outfile})
  ENDFOREACH (it)
ENDMACRO (TULIP_QT5_WRAP_UI_IN_INCLUDE_TULIP)
...
MACRO (TULIP_QT5_WRAP_CPP outfiles )
