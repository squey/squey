...
function(ADD_SQUISH_TEST testName autName suiteName testCase)
	...
	set_tests_properties(${testName} PROPERTIES ENVIRONMENT "SQUISH_SCRIPT_DIR=@CMAKE_SOURCE_DIR@/tests/squish/scripts" FAIL_REGULAR_EXPRESSION "")
        set_tests_properties(${testName} PROPERTIES ENVIRONMENT "INSPECTOR_TESTS_DIR=@CMAKE_SOURCE_DIR@/tests" FAIL_REGULAR_EXPRESSION "")
    endif()
endfunction()

function(ADD_SQUISH_TARGET_TEST testName autTarget suiteName testCase)
    if (SQUISH_FOUND)
        get_target_property(testPath ${autTarget} LOCATION)
        ADD_SQUISH_TEST(${testName} ${testPath} ${suiteName} ${testCase})
    endif()
endfunction()
