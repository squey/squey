...
if(PICVIZ_SINGLE_TREE_BUILD)
	if(WIN32)
		set(PVGL_FOUND true)
		set(PVGL_INCLUDE_DIR "${picviz-inspector_SOURCE_DIR}\\libpvgl\\src\\include")
		set(PVGL_LIBRARY "${picviz-inspector_SOURCE_DIR}\\libpvgl\\src\\${CMAKE_BUILD_TYPE}\\pvgl.lib")
	else(WIN32)
		set(PVGL_FOUND true)
		set(PVGL_INCLUDE_DIR "${picviz-inspector_SOURCE_DIR}/libpvgl/src/include")
		set(PVGL_LIBRARY "${picviz-inspector_SOURCE_DIR}/libpvgl/src/libpvgl.so")
	endif(WIN32)
