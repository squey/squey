...
if(PICVIZ_SINGLE_TREE_BUILD)
	if(WIN32)
		...
		set(PICVIZ_INCLUDE_DIR "${picviz-inspector_SOURCE_DIR}\\libpicviz\\src\\include")
		set(PICVIZ_LIBRARY "${picviz-inspector_SOURCE_DIR}\\libpicviz\\src\\${CMAKE_BUILD_TYPE}\\picviz.lib")
	else(WIN32)
		set(PICVIZ_FOUND true)
		set(PICVIZ_INCLUDE_DIR "${picviz-inspector_SOURCE_DIR}/libpicviz/src/include")
		set(PICVIZ_LIBRARY "${picviz-inspector_SOURCE_DIR}/libpicviz/src/libpicviz.so")
	endif(WIN32)
