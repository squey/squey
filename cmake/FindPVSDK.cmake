...
if(PICVIZ_SINGLE_TREE_BUILD)
	if(WIN32)
		...
		set(PVSDK_INCLUDE_DIR "${picviz-inspector_SOURCE_DIR}\\libpvsdk\\src\\include")
		set(PVSDK_LIBRARY "${picviz-inspector_SOURCE_DIR}\\libpvsdk\\src\\${CMAKE_BUILD_TYPE}\\pvsdk.lib")
	else(WIN32)
		set(PVSDK_FOUND true)
		set(PVSDK_INCLUDE_DIR "${picviz-inspector_SOURCE_DIR}/libpvsdk/src/include")
		set(PVSDK_LIBRARY "${picviz-inspector_SOURCE_DIR}/libpvsdk/src/libpvsdk.so")
	endif(WIN32)
