...
nsSBCSGroupProber::nsSBCSGroupProber()
{
	...
	mProbers[11] =
	    new nsSingleByteCharSetProber(&Win1255Model, PR_FALSE, hebprober); // Logical Hebrew
	mProbers[12] =
	    new nsSingleByteCharSetProber(&Win1255Model, PR_TRUE, hebprober); // Visual Hebrew
