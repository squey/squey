...
class PVCountedBase
{
  public:
	...
	long add_ref_copy() { return _use_count.fetch_and_increment(); }

	long add_ref_lock() { return _use_count.fetch_and_increment() != 0; }
	...
	long weak_add_ref() { return _weak_count.fetch_and_increment(); }
	...
	long use_count() const { return _use_count.fetch_and_add((long)0); }
