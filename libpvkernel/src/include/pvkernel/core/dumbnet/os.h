...
#ifndef DNET_BYTESEX
#if defined(vax) || defined(ns32000) || defined(sun386) || defined(i386) || defined(MIPSEL) ||     \
    defined(_MIPSEL) || defined(BIT_ZERO_ON_RIGHT) || defined(__alpha__) || defined(__alpha)
#define DNET_BYTESEX DNET_LIL_ENDIAN
#elif defined(sel) || defined(pyr) || defined(mc68000) || defined(sparc) || defined(is68k) ||      \
    ...
    defined(__hp9000s700) || defined(__ia64) || defined(BIT_ZERO_ON_LEFT) || defined(m68k)
#define DNET_BYTESEX DNET_BIG_ENDIAN
#else
