...
static constexpr const char* log_file = TEST_FOLDER "/pvkernel/rush/splitters/pcap/kim.pcap";
static constexpr const char* ref_file = TEST_FOLDER "/pvkernel/rush/splitters/pcap/kim.pcap.out";


int main()
{
	pvtest::TestSplitter<PVRush::PVInputPcap> ts(log_file, nb_dup);
