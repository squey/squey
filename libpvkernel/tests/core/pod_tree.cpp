...
int main()
{
	...
	{
		PVCore::PVPODTree<uint32_t, uint32_t, 1 << 20>* pod_tree =
		    new PVCore::PVPODTree<uint32_t, uint32_t, 1 << 20>(104);
		delete pod_tree;
	}
	{
		PVCore::PVPODTree<uint32_t, uint32_t, 1 << 20>* pod_tree =
		    new PVCore::PVPODTree<uint32_t, uint32_t, 1 << 20>(100000);
		delete pod_tree;
	}
	...
	PVCore::PVPODTree<uint32_t, uint32_t, 1 << 20>* pod_tree =
	    new PVCore::PVPODTree<uint32_t, uint32_t, 1 << 20>(nelts);
