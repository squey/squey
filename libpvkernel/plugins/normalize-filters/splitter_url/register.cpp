...
LibCPPExport void register_class()
{
	...
	DECLARE_TAG(PVAXIS_TAG_URL_VARIABLES, PVAXIS_TAG_URL_VARIABLES_DESC,
	            PVFilter::PVFieldSplitterURL);
	DECLARE_TAG(PVAXIS_TAG_URL_FRAGMENT, PVAXIS_TAG_URL_VARIABLES_DESC,
	            PVFilter::PVFieldSplitterURL);
	DECLARE_TAG(PVAXIS_TAG_URL_CREDENTIALS, PVAXIS_TAG_URL_VARIABLES_DESC,
	            PVFilter::PVFieldSplitterURL);
}
