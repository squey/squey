...
enum mandatory_mapping_param_type { mandatory_ymin, mandatory_ymax };

// typedef tbb::concurrent_unordered_map<mandatory_mapping_param_type, mandatory_param_value>
// mandatory_param_map;
typedef std::map<mandatory_mapping_param_type, mandatory_param_value> mandatory_param_map;

class PVMandatoryMappingFilter
    : public PVFilter::PVFilterFunctionBase<int, mandatory_param_value const&>,
      public PVCore::PVRegistrableClass<PVMandatoryMappingFilter>
{
  public:
