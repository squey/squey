...
public:
	...
	PVPlottingModeWidget(PVCol axis_id, Inendi::PVPlotting& plotting, bool params_btn = false, QWidget* parent = NULL);
	PVPlottingModeWidget(PVCol axis_id, Inendi::PVView& view, bool params_btn = false, QWidget* parent = NULL);
