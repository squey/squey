...
class PVMappingFilter: public PVFilter::PVFilterFunctionBase<Inendi::mapped_decimal_storage_type, PVCore::PVField const&>, public PVCore::PVRegistrableClass<PVMappingFilter>
{
public:
