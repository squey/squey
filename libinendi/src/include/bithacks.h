...
#define B8IFY(Y)                                                                                   \
	(((Y & 0x0000000FLU) ? 1 : 0) + ((Y & 0x000000F0LU) ? 2 : 0) + ((Y & 0x00000F00LU) ? 4 : 0) +  \
	 ((Y & 0x0000F000LU) ? 8 : 0) + ((Y & 0x000F0000LU) ? 16 : 0) +                                \
	 ((Y & 0x00F00000LU) ? 32 : 0) + ((Y & 0x0F000000LU) ? 64 : 0) +                               \
...
// Count set bits in parallel and add the result to res
// From http://graphics.stanford.edu/~seander/bithacks.html
// WARNING: the value of 'v' *will* be changed !
