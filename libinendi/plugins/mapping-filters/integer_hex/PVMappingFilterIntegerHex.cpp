...
Inendi::PVMappingFilterIntegerHex::PVMappingFilterIntegerHex(PVCore::PVArgumentList const& args):
...
DEFAULT_ARGS_FILTER(Inendi::PVMappingFilterIntegerHex)
{
...
void Inendi::PVMappingFilterIntegerHex::set_args(PVCore::PVArgumentList const& args)
{
	Inendi::PVMappingFilter::set_args(args);
}

PVCore::DecimalType Inendi::PVMappingFilterIntegerHex::get_decimal_type() const
{
...
IMPL_FILTER_NOPARAM(Inendi::PVMappingFilterIntegerHex)
