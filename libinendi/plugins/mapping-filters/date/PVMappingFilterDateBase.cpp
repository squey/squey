...
Inendi::date_tls_parser::date_tls_parser() :
	_cal(nullptr)
{}
...
void Inendi::date_tls_parser::init(QStringList const& time_format)
{
	if (_cal) {
		return;
	}
...
void Inendi::PVMappingFilterDateBase::init()
{
}

Inendi::PVMappingFilter::decimal_storage_type Inendi::date_mapping::process_utf8(const char* buf,
                                                                                 size_t size,
                                                                                 PVMappingFilter* m)
{
...
Inendi::PVMappingFilter::decimal_storage_type Inendi::date_mapping::process_utf16(uint16_t const* buf,
                                                                                  size_t size,
                                                                                  PVMappingFilter* m)
{
...
DEFAULT_ARGS_FILTER(Inendi::PVMappingFilterDateBase)
{
