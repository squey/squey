...
static constexpr const char* csv_file_format = TEST_FOLDER "/picviz/datetime_24h_mapping.csv.format";
...
int main()
{
    ...
    std::sort(order.begin(), order.end(), [&array](uint32_t a, uint32_t b) { return (array[a] % (24 * 3600)) < (array[b] % (24 * 3600)); });
