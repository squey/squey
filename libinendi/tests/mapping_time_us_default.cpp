...
static constexpr const char* csv_file_format = TEST_FOLDER "/picviz/datetime_us_default_mapping.csv.format";
...
int main()
{
    ...
    std::sort(order.begin(), order.end(), [&array](uint32_t a, uint32_t b) { return array[a] < array[b]; });
