...
int main(int argc, char **argv)
{
	...
	*
	**********************************************************************/
	printf("We test CONSTRUCTOR/DESTRUCTOR for inendi_color_t\n");
	color1 = inendi_color_new();
	inendi_color_destroy(color1);
	
	

	/**********************************************************************
	*
	* We test inendi_color_new and all inendi_color_get_[r,g,b,a,h,s,v]
	*
	**********************************************************************/
	printf("\nWe test inendi_color_get_[r,g,b,a,h,s,v]\n");
	color1 = inendi_color_new();
	r_value = inendi_color_get_r(color1);
	printf("This is the R value of a just-created color (should be 0): %d\n", r_value);
	g_value = inendi_color_get_g(color1);
	printf("This is the G value of a just-created color (should be 0): %d\n", g_value);
	b_value = inendi_color_get_b(color1);
	printf("This is the B value of a just-created color (should be 0): %d\n", b_value);
	a_value = inendi_color_get_a(color1);
	printf("This is the A value of a just-created color (should be 255): %d\n", a_value);
	h_value = inendi_color_get_h(color1);
	printf("This is the H value of a just-created color (should be 0): %f\n", h_value);
	s_value = inendi_color_get_s(color1);
	printf("This is the S value of a just-created color (should be 0): %f\n", s_value);
	v_value = inendi_color_get_v(color1);
	...
	if (!good)
	{
		printf("Color test : [%d] : inendi_color_new or inendi_color_get_[r,g,b,a,h,s,v] : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test all inendi_color_set_[r,g,b,a,h,s,v]
	*
	**********************************************************************/
	printf("\nWe test inendi_color_set_[r,g,b,a,h,s,v]\n");
	inendi_color_set_r(color1, 15);
	r_value = inendi_color_get_r(color1);
	printf("The R value of our color should be 15 : %d\n", r_value);
	
	inendi_color_set_g(color1, 16);
	g_value = inendi_color_get_g(color1);
	printf("The G value of our color should be 16 : %d\n", g_value);
	
	inendi_color_set_b(color1, 17);
	b_value = inendi_color_get_b(color1);
	printf("The B value of our color should be 17 : %d\n", b_value);
	
	inendi_color_set_a(color1, 18);
	a_value = inendi_color_get_a(color1);
	printf("The A value of our color should be 18 : %d\n", a_value);
	
	inendi_color_set_h(color1, 19.19);
	h_value = inendi_color_get_h(color1);
	printf("The H value of our color should be 19.19 : %f\n",h_value);
	
	inendi_color_set_s(color1, 0.20);
	s_value = inendi_color_get_s(color1);
	printf("The S value of our color should be 0.20 : %f\n", s_value);
	
	inendi_color_set_v(color1, 0.30);
	v_value = inendi_color_get_v(color1);
	...
	if (!good)
	{
		printf("Color test : [%d] : inendi_color_set_[r,g,b,a,h,s,v] : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test inendi_color_set_rgba
	*
	**********************************************************************/
	printf("\nWe test inendi_color_set_rgba\n");
	inendi_color_set_rgba(color1, 11, 22, 33, 44);
	r_value = inendi_color_get_r(color1);
	...
	if (!good) {
		printf("Color test : [%d] : inendi_color_set_rgba : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test inendi_color_set_hsv
	*
	**********************************************************************/
	printf("\nWe test inendi_color_set_hsv\n");
	inendi_color_set_hsv(color1, 120, 0.5, 0.5);
	h_value = inendi_color_get_h(color1);
	...
	if (!good) {
		printf("Color test : [%d] : inendi_color_set_hsv : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test inendi_color_A2B_copy
	*
	**********************************************************************/
	printf("\nWe test inendi_color_A2B_copy\n");
	color2 = inendi_color_new();
	inendi_color_A2B_copy(color1, color2);
	...
	inendi_color_destroy(color2);
	
	if (!good) {
		printf("Color test : [%d] : inendi_color_A2B_copy : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test inendi_color_hsv_to_rgb
	*
	**********************************************************************/
	printf("\nWe test inendi_color_hsv_to_rgb \n");
	inendi_color_destroy(color1);
	...
	inendi_color_set_hsv(color1, 201, 0.50196, 0.862745);
	inendi_color_hsv_to_rgb(color1);
	r_value = inendi_color_get_r(color1);
	...
	if (!good) {
		printf("Color test : [%d] : inendi_color_hsv_to_rgb : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test inendi_color_rgb_to_hsv
	*
	**********************************************************************/
	printf("\nWe try to set RGB(51, 40, 102) as an RBGA color, apply inendi_color_rgb_to_hsv and test all the values\n");
	inendi_color_set_rgba(color1, 51, 40, 102, 255);
	inendi_color_rgb_to_hsv(color1);
	r_value = inendi_color_get_r(color1);
	...
	if (!good) {
		printf("Color test : [%d] : inendi_color_rgb_to_hsv : failed\n", __LINE__);
		return 1;
	}
	...
	/**********************************************************************
	*
	* We test inendi_color_extract_[r/g/b]_from_html_code
	*
	**********************************************************************/
	printf("\nWe test the inendi_color_extract_[r/g/b]_from_html_code functions\n");
	printf("We use the #326496 Hex color\n");
	r_value = inendi_color_extract_r_from_html_code("#326496");
	printf("This is the R value (should be 50): %d\n", r_value);
	g_value = inendi_color_extract_g_from_html_code("#326496");
	printf("This is the G value (should be 100): %d\n", g_value);
	b_value = inendi_color_extract_b_from_html_code("#326496");
	printf("This is the B value (should be 150): %d\n", b_value);
	
	good = (r_value == 50) && (g_value == 100) && (b_value == 150);
	if (!good) {
		printf("Color test : [%d] : inendi_color_extract_[r/g/b]_from_html_code : failed\n", __LINE__);
		return 1;
	}
