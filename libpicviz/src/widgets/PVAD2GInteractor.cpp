...
void PVWidgets::AD2GInteractorComponent::abort_edge_tracing()
{
	_bends.clear();
	_edge_started = false;
	clearObserver();
...
void PVWidgets::AD2GInteractorComponent::addLink()
{
...
void PVWidgets::AD2GInteractorComponent::mouse_translate(tlp::node /* n*/, double newX, double newY, tlp::GlMainWidget *glMainWidget) {
