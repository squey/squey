...
static int _picviz_selection_printf(long offset, char *line, size_t linesize, void *userdata)
{
	picviz_selection_t *selection = (picviz_selection_t *)userdata;
	int line_selected;
	
	line_selected = picviz_selection_get_line(selection, line_count);
	if (line_selected) {
		printf("%s\n", line);
	}
