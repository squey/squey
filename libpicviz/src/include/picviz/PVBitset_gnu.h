// AG: ok this is an overkill solution I know it...
// A copy of the original GNU's bitset C++ class, with access granted
// to the internal buffer
//
// The real good solution would be to make our own...
