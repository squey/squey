 ...
 *
 */
#ifndef PVMOUSEMOVESELECTION_H
#define PVMOUSEMOVESELECTION_H
...
class PVMouseSelectionEditor:public InteractorComponent {

public:

  PVMouseSelectionEditor();
  ~PVMouseSelectionEditor();
  bool compute(GlMainWidget *glMainWidget);
  bool draw(GlMainWidget *);
  bool eventFilter(QObject *, QEvent *);
  InteractorComponent *clone() {
    return new PVMouseSelectionEditor();
  }
