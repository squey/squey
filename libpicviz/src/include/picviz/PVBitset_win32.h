...
public: // AG: This is the hack the MS way
	enum
	...
	_Ty _Array[_Words + 1];	// AG: the set of bits
	_Ty* _M_w; // AG: Pointer to _Array, in order to have the same access than GNU's version
	};
